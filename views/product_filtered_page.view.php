                ...
                <div id="mfilter-content-container">
                        ...
                        <div class="image col-sm-3">
                          ...
                          <a href="index3f41.html?route=product/product&amp;path=20&amp;product_id=44">
                            <img src="http://localhost/emazonResource/images/blank.gif"
                             alt="Funda Para Ebook 7&quot; 128GB full HD" />ss
                          </a>
                        </div>

                        <div class="name-desc col-sm-6">
                          <div class="name">
                            <a href="index3f41.html?route=product/product&amp;path=20&amp;product_id=44">ssss</a>
                          </div>
                  ...
                  <div class="product-grid" class="active">
                    ...
                    <div class="row">
                      ...
                      <?php foreach( array_slice(query(),4,12) as $product): ?>
                              ...
                              <div class='image '>
                                ...
                                <a href='/emazon/product?route=product/product_id=".$product->getProductCode()."'>
                                  ...
                                  <img src='http://localhost/emazonResource/images/blank.gif'data-echo=".$product->getProductFrontImage()."
                                   alt=".$product->getProductName()." class='' />
                                </a>
                              </div>
                            </div>
                            <div class='right'>
